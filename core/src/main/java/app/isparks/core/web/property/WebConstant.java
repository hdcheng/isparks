...
public final class WebConstant {
    ...
    public final static String ADMIN_TEMPLATE_CLASSPATH = "classpath:/" + ADMIN_TEMPLATE_PATH;

    // plugin页面模板文件classpath路径
    public final static String PLUGIN_TEMPLATE_PATH = "plugin";

    // plugin页面模板文件路径
    public final static String PLUGIN_TEMPLATE_CLASSPATH = "classpath:/" + PLUGIN_TEMPLATE_PATH;

    // web页面模板文件路径
    public final static String WEB_TEMPLATE_PATH = "web";

    // web页面模板文件classpath路径
    public final static String WEB_TEMPLATE_CLASSPATH = "classpath:/" + WEB_TEMPLATE_PATH;
